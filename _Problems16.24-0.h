...
#define PP_KK	16		// Maximal number of edges that include surface point (compilator limit: 2 147 483 647)
...
#define PP_KK	17		// Maximal number of edges that include surface point (compilator limit: 2 147 483 647)
...
#define PP_KK	18		// Maximal number of edges that include surface point (compilator limit: 2 147 483 647)
...
#define PP_KK	19		// Maximal number of edges that include surface point (compilator limit: 2 147 483 647)
