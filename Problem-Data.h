...
static int PD_meu;					// Number of edges that include surface point
static int PD_mnep;					// Number of inequality-hyperplanes used for pseudoprojection
...
static int PD_edgeAllHyperplanes[PP_N - 1];	// Index of all hyperplanes used for pseudoprojection
